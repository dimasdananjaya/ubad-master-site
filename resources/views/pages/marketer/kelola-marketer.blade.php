    ...
    <section id="kelola-marketer">
        <div class="container pb-3 pt-3 mt-5">
            <div class="card pt-3 pb-4 dx-block mx-auto">
                ...
                <table class="table table-striped table-bordered table-hover mt-2 table-responsive-sm">
                    <thead>
                        <th>Nama</th>
                        <th>Whatsapp</th>
                        <th>Email</th>
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">                  
                                            {!!Form::open(['action'=>['PendaftaranController@update', $dtm->id_marketer], 'method'=>'PUT'])!!}
                                                {{Form::label('Status','Status :')}}
                                                <select name="status" class="form-group form-control">
                                                    <option value="official_marketer">Official Marketer</option>
                                                </select>
